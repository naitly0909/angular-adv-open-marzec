...
import { tap, takeUntil, multicast, refCount, share, shareReplay } from 'rxjs/operators';
import {
  Subscription,
  Subject,
...
export class MusicSearchComponent implements OnInit {
  ...
  // results$ = this.service.getAlbums().pipe(multicast(() => new ReplaySubject(1)));
  results$ = this.service.getAlbums().pipe(
